...
RUN apt update && \
    ...
    apt install git iproute2 wget -y && \
    ...
    wget -O - https://fogproject.org/kernels/Kernel.TomElliott.4.15.2.64 > /var/www/fog/service/ipxe/bzImage && \
    wget -O - https://fogproject.org/kernels/Kernel.TomElliott.4.15.2.32 > /var/www/fog/service/ipxe/bzImage32
